import re
mystr = "Learn Python including"

a = re.search("Learn", mystr)
print(a.group())

ip = "2.2.2.1  2  mac:b4:5c:8d VLAN#222    L"
a = re.search(r"(.+?) +(\d)", ip)
print(a.group())
a = re.search(r"(.+?) +(\d)\s(.+) (.+)\s{2,} (\w)*", ip)
print(a.group(1))
print(a.group(2))
print(a.group(3))
print(a.group(4))
...
ips = ['33.33.33.33', '1.1.1.1', '2.2.2.2']
for ip in ips:
    al = re.findall(r"\d{2}\.\d\d\.[0-9]{2}\.\d{2}", ip)
    print(al)
